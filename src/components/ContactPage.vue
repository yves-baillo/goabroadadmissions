<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <!-- Contact Hero Section with Background Image - Increased Height -->
    <section class="relative h-[500px] md:h-[600px] lg:h-[850px] -mt-20">
      ...
      <div class="relative z-10 h-full flex items-center justify-center text-white">
        <div class="container mx-auto px-4 text-center">
          ...
          <p class="text-xl md:text-2xl max-w-2xl mx-auto opacity-95">Get in touch with our team. We're here to help you achieve your study abroad dreams. Just contact use through different lines provided or to the social media platforms</p>
              ...
              <div class="space-y-6">
                ...
                <div class="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p class="text-gray-500">alexishakizimana149@gmail.com</p>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p class="text-gray-500">+250 738 123 457</p>
                  </div>
                </div>
...
// ✅ UPDATED API URL – Vercel backend
